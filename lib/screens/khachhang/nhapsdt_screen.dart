...
class NhapSdtScreen extends StatefulWidget {
  ...
  const NhapSdtScreen({Key? key, required this.email, required this.matKhau}) : super(key: key);
...
class _NhapSdtScreenState extends State<NhapSdtScreen> {
  ...
  void _guiOtp() async {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => OtpScreen(email: widget.email, matKhau: widget.matKhau, soDienThoai: sdt),
      ),
    );
  }
              ...
              child: ConstrainedBox(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text('Add Phone Number', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w800, color: textDark)),
                    const SizedBox(height: 8),
                    const Text('We will sent an OTP Verification for you.', style: TextStyle(fontSize: 14, color: textGrey)),
                    ...
                    SizedBox(
                      ...
                      child: DecoratedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: _dangGuiOtp ? const SizedBox(width: 22, height: 22, child: CircularProgressIndicator(strokeWidth: 2.2, color: Colors.white)) : const Text('Send me the OTP', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w700, color: Colors.white)),
                        ),
                      ),
                    ),
                  ],
