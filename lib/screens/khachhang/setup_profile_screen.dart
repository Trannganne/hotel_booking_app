...
class _SetupProfileScreenState extends State<SetupProfileScreen> {
  ...
  final TextEditingController _quocGiaController = TextEditingController(text: 'VietNam');
  final TextEditingController _tinhController = TextEditingController(text: 'Ba Ria - Vung Tau');
  final TextEditingController _thanhPhoController = TextEditingController(text: 'Vung Tau');
              ...
              child: ConstrainedBox(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Expanded(child: _input(controller: _hoController, hintText: 'First Name')),
                        const SizedBox(width: 10),
                        Expanded(child: _input(controller: _tenController, hintText: 'Last Name')),
                      ],
                    ),
                    const SizedBox(height: 12),
                    _input(controller: _ngaySinhController, hintText: 'Birth Date', icon: Icons.calendar_month_outlined),
                    const SizedBox(height: 12),
                    ...
                    Row(
                      children: [
                        Expanded(child: _input(controller: _thanhPhoController, hintText: 'City')),
                        const SizedBox(width: 10),
                        Expanded(child: _input(controller: _zipController, hintText: 'Zip Code', keyboardType: TextInputType.number)),
                      ],
                    ),
                      ...
                      child: DecoratedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: _dangTaoTaiKhoan
                              ...
                              : const Text('Start Your Journey', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w700, color: Colors.white)),
                        ),
                      ),
                    ),
                    ...
                    SizedBox(
                      ...
                      child: OutlinedButton(
                        ...
                        child: const Text('Skip', style: TextStyle(color: textGrey, fontWeight: FontWeight.w700)),
                      ),
                    ),
                  ],
                ),
