...
class _TaiKhoanKhScreenState extends State<TaiKhoanKhScreen> {
  ...
  Future<void> _loadThongTin() async {
    try {
      ...
      _sdtController.text = data?['soDienThoai']?.toString() ?? '';
      _ngaySinhController.text = data?['ngaySinh']?.toString() ?? '';
      _quocGiaController.text = data?['quocGia']?.toString() ?? '';
      _tinhThanhController.text = data?['tinhThanh']?.toString() ?? '';
