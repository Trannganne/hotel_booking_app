...
class AuthGate extends StatelessWidget {
  ...
  Future<Widget> _kiemTraManHinhTiepTheo(User user) async {
    ...
    // Admin cố định được vào thẳng trang admin
    // Nếu bạn muốn admin cũng phải xác minh email, đưa đoạn này xuống dưới phần emailVerified
    ...
    // User thường phải setup profile
