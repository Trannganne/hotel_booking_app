        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              const Text("Register to continue", style: TextStyle(color: Colors.grey)),
                  ...
                  children: [
                    ...
                    _input(
                      ...
                      suffix: IconButton(
                        ...
                        icon: Icon(_anXacNhan ? Icons.visibility : Icons.visibility_off),
                      ),
                      validator: (v) => v != _matKhauController.text ? "Không khớp mật khẩu" : null,
                    ),
                  ],
                ),
              ),
              ...
              Row(
                children: [
                  Checkbox(value: _dongY, onChanged: (v) => setState(() => _dongY = v!)),
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        enabledBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(10),
          borderSide: BorderSide(color: errorText != null ? errorColor : const Color(0xFFE1E8F0)),
        ),
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(10),
          borderSide: BorderSide(color: errorText != null ? errorColor : const Color(0xFF63D2DE)),
        ),
      ),
    );
  }
